...
import pandas as pd
csvdata = pd.read_csv('simex1_proposed_outputs.csv')
...
plt.plot(time_case2, h1_case2, label='w/o pressure const.', zorder=2, ls='-', lw=1.5, c='b')
plt.plot(time_case3, h1_case3, label='w/  pressure const.', zorder=2, ls='-', lw=1.5, c='g')
...
plt.savefig('simex2_constraint_outputs.pdf', bbox_inches="tight")
plt.show()
...
# csvdata = pd.read_csv('simex1_proposed_inputs_etc.csv')
# time = csvdata['time']
# in1 = csvdata['in1']
# in2 = csvdata['in2']
...
# # グラフの周囲の余白をゼロに設定します
# plt.margins(0)
# plt.savefig('simex1_proposed_inputs.pdf', bbox_inches="tight")
# plt.show()
...
# plt.plot(time, caltime, label='input 1', zorder=3, ls='-', lw=1.5, c='b')
# # 水平線
# # x軸とy軸のラベルを設定します
# #plt.xlabel('')
# plt.xlabel('Time [s]', fontsize=10)
...
# # グラフの周囲の余白をゼロに設定します
# plt.margins(0)
# plt.savefig('simex1_proposed_caltime.pdf', bbox_inches="tight")
