...
csvdata = pd.read_csv('simex1_weight_Qe0.1_Qh0.001.csv')
...
csvdata = pd.read_csv('simex2_input_Qe0.1_Qh0.001.csv')
...
plt.plot(time_case1, h1_case1,    label='w/o input const.', zorder=2, ls='-', lw=1.5, c='g')
#plt.plot(time_case2, h1_case2,    label='$Q_\mathrm{h1}=0.10$', zorder=2, ls='-', lw=1.5, c='g')
plt.plot(time_case3, h1_case3,    label='w/ input const.', zorder=2, ls='-', lw=1.5, c='b')
# 軸ラベルの設定
...
plt.savefig('simex2_input.pdf', bbox_inches="tight")
