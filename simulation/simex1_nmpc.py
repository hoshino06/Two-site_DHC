...
# csvdata = pd.read_csv('simex1_pdel04.csv')
...
plt.savefig('simex1_nmpc_outputs.pdf', bbox_inches="tight")
plt.show()
...
plt.plot(time2, caltime2, label='1e-5', zorder=3, ls='-', lw=1.5, c='b')
...
# グラフの周囲の余白をゼロに設定します
plt.margins(0)
plt.savefig('simex1_nmpc_caltime.pdf', bbox_inches="tight")
