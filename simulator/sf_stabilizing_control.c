 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Tue Feb 28 07:35:29 2023
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                sf_stabilizing_control
...
extern void sf_stabilizing_control_Outputs_wrapper(const real_T *x,
  const real_T *v,
  real_T *u);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  sf_stabilizing_control_Outputs_wrapper(x, v, u);
}
