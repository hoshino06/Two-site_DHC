...
block.OutputPort(3).Dimensions   = 1; % for computational time
block.OutputPort(3).DatatypeID  = 0; % double
block.OutputPort(3).Complexity  = 'Real';
block.OutputPort(3).SamplingMode = 'Sample';

block.OutputPort(4).Dimensions   = 2; % for control input u
...
block.OutputPort(4).Data = mf_stabilizing_control( x_k, v(1:2) );
